...
#ifndef __SIMPLE_RECIPIENT_FILTER_H__
#define __SIMPLE_RECIPIENT_FILTER_H__
...
namespace cssmatch
{
	...
	public:
		...
		/** Get the vector encapsulated in the recipient list */
		const std::vector<int> * getVector() const;
	};
}

#endif // __SIMPLE_RECIPIENT_FILTER_H__
