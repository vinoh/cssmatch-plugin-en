...
namespace cssmatch
{
	...
	public:
		 ...
		 * @param message The message to send
		 */
		void chatWarning(	RecipientFilter & recipients, 
							const std::string & message);
		 ...
		 * @param message The message to send
		 */
		void hintSay(	RecipientFilter & recipients,
						const std::string & message);
		 ...
		 * @param message The message to send
		 */
		void centerSay(	RecipientFilter & recipients,
						const std::string & message);
		 ...
		 * @param message The message to send
		 */
		void consoleSay(	RecipientFilter & recipients,
							const std::string & message);
	};
}
