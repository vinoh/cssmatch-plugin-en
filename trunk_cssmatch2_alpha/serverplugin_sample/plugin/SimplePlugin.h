...
#include "../messages/SimpleRecipientFilter.h"

#include "../singleton/BaseSingleton.h"
#include "../convars/SimpleConvarsAccessor.h"
#include "../match/SimpleMatchManager.h"
...
namespace cssmatch
{
	...
	public:
		...
		SimpleMatchManager * getMatchManager();
		...
		/** Immediatly execute a configuration file, then immediatly execute the command read from the file
		 * @param path The path to the configuration file
		 */
		void immediatlyExecConfig(const std::string & path) const;
