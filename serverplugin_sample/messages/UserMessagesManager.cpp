...
namespace cssmatch
{
	...
	void UserMessagesManager::chatSay(	SimpleRecipientFilter & recipients,
	...
	void UserMessagesManager::chatWarning(	SimpleRecipientFilter & recipients,
											const std::string & message)
	{
		bf_write * pBitBuf = engine->UserMessageBegin(&recipients,MESSAGE_SAYTEXT);
	...
	void UserMessagesManager::popupSay(	SimpleRecipientFilter & recipients,
										const std::string & message,
										int lifeTime,
	...
	void UserMessagesManager::hintSay(	SimpleRecipientFilter & recipients,
										const std::string & message)
	{
	...
	void UserMessagesManager::centerSay(SimpleRecipientFilter & recipients,
										const std::string & message)
	{
	...
	void UserMessagesManager::consoleSay(	SimpleRecipientFilter & recipients,
											const std::string & message)
	{
